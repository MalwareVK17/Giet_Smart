...
class StudentIdUploadPage extends StatefulWidget {
  const StudentIdUploadPage({super.key});

  @override
  State<StudentIdUploadPage> createState() => _StudentIdUploadPageState();
}

class _StudentIdUploadPageState extends State<StudentIdUploadPage> {
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Student ID details have been uploaded\nand are being processed.',
